...
function twentythirteen_setup() {
	...
	//miniatura principal destaque mosaico-homepage
	add_image_size('thumb-destaque-mosaico', 644, 485);

	//miniatura normal mosaico-homepage
	add_image_size('thumb-normal-mosaico', 320, 238, true);

	//miniatura da página de noticia/post
	//add_image_size('single-post-thumbnail', 1040, 580);

	//miniatura da pagina principal
	// add_image_size('thumb-destaque', 604, 270, true);
